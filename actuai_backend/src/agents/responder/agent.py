...
ROLE
----
This agent handles ONE specific inbound case in mission M1: a *client* writes in
asking when their equipment will be delivered (a delivery-time / ETA enquiry).
